...
# Run: ./scripts/install-layer-5.sh
#
# Context7 Verified (February 2026):
# - Claude Code: Score 80.6 (/anthropics/claude-code) - curl/npm
# - Gemini CLI: Score 78.2 (/google-gemini/gemini-cli) - npm
# - Codex CLI: Score 56.9 (/openai/codex) - npm
...
echo "  Claude Code: 80.6 (/anthropics/claude-code)"
echo "  Gemini CLI:  78.2 (/google-gemini/gemini-cli)"
echo "  Codex CLI:   56.9 (/openai/codex)"
